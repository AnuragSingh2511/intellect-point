...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        'flex-1 rounded-none border-0 bg-background shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-background',
        className,
      )}
      {...props}
    />
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        'flex-1 resize-none rounded-none border-0 bg-background py-2 shadow-none ring-0 focus-visible:ring-0 aria-invalid:ring-0 dark:bg-background',
        className,
      )}
      {...props}
    />
