  ...
  return (
    <TabsPrimitive.Trigger
      ...
      className={cn(
        ...
        'group-data-[variant=line]/tabs-list:bg-background group-data-[variant=line]/tabs-list:data-active:bg-background dark:group-data-[variant=line]/tabs-list:data-active:border-transparent dark:group-data-[variant=line]/tabs-list:data-active:bg-background',
